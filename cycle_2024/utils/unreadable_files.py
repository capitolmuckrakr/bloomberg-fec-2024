import os, sys
import logging
from cycle_2024.models import FilingStatus

LOGLEVEL = os.environ.get('LOGLEVEL', 'INFO').upper()
logger = logging.getLogger("bloomberg-fec."+__name__)
...
def delete_file(filing_id, filing_dir=filing_dir, myextra=None):
    ...
    """
    filenames = []
    filenames.append('{}{}.csv'.format(filing_dir, filing_id))
    filenames.append('{}{}.fec'.format(filing_dir, filing_id))
    if myextra:
        myextra=myextra.copy()
