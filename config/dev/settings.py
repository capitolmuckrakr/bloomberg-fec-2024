    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': os.path.join(
                '/home/ubuntu/scripts/bloomberg-fec', 'django_errors.log'),
        },
    },
    'loggers': {
        'bloomberg-fec': {
...
AWS_STORAGE_BUCKET_NAME = 'bloomberg-fec-multicycle-static'
...
STATICFILES_DIRS = [
        os.path.join(BASE_DIR, '../cycle_2020/static'),
        os.path.join(BASE_DIR, '../cycle_2022/static'),
        os.path.join(BASE_DIR, '../cycle_2024/static'),
#        '/var/www/static',
]
