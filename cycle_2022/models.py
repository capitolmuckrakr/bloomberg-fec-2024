...
class Committee(BaseModel):
    ...
    def get_absolute_url(self):
        return '/2022/committee/%s' % self.fec_id
...
class ScheduleA(Transaction):
    ...
    donor = models.ForeignKey('donor.Donor', null=True, blank=True, related_name='contributions_2022', on_delete=models.SET_NULL)
...
class ScheduleE(Transaction):
    ...
    memo_code = models.CharField(max_length=255, null=True, blank=True)
    memo_text_description = models.CharField(max_length=255, null=True, blank=True)
    bloomberg_district = models.CharField(max_length=255, null=True, blank=True)
    name_search = SearchVectorField(null=True)
    purpose_search = SearchVectorField(null=True)
...
class Candidate(BaseModel):
    ...
    bloomberg_candidate_id = models.CharField(max_length=9, null=True, blank=True)
